<template>
	...
	>
		...
		<div class="drawer-content">
			...
			<div class="download">
				<a-button type="dark" href="https:/joindomos.com" block target="_blank">Visit Homepage</a-button>
				<a-button type="primary" href="https:/joindomos.com" block target="_blank">UPGRADE</a-button>
				<a-button type="secondary" href="https:/joindomos.com" block target="_blank">Learn more</a-button>
			</div>
			
			<div class="sharing">
				<h6>Thank you for sharing!</h6>
				<div class="share-links">
					<a-button type="dark" target="_blank" href="https://twitter.com/intent/tweet?url=https:/joindomos.com" size="small">
					...
					<a-button type="dark" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https:/joindomos.com"  size="small">
