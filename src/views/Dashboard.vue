...
<script>
	...
	const projects = [
		...
		{
			id: 2,
			title: "Prepare agenda for board meeting",
		...
		},
		{
			...
			content: "The handle on the entrance door is very loose and about to fall.",
